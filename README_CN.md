...
> 🗣️ "安装 follow-news，加上我的 RSS 源，并包含 `kol` 主题"
...
**排名信号**：优先级源、多源交叉验证、时效性、互动度、Reddit 讨论热度以及已报道惩罚。
